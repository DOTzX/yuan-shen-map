...
var LayerMap = {
  ...
  Layer_JW_SJLXJ: L.markerClusterGroup(),
  Layer_BX_SJLXJ: L.markerClusterGroup({
    maxClusterRadius: function (e) {
      let radius = 0
      if (e == -3) radius = 100
      else if (e == -2) radius = 80
  ...
  Layer_QKBX_SJLXJ: L.markerClusterGroup(),
  Layer_DLK_SJLXJ: L.markerClusterGroup(),
  Layer_SJRW_SJLXJ: L.markerClusterGroup(),
  Layer_TFWT_SJLXJ: L.markerClusterGroup(),
  Layer_ASKK_SJLXJ: L.markerClusterGroup(),
  Layer_ND_SJLXJ: L.markerClusterGroup(),
  Layer_JWJZ_SJLXJ: L.markerClusterGroup(),
  Layer_CSZX_SJLXJ: L.markerClusterGroup(),
  Layer_TYCS_SJLXJ: L.markerClusterGroup(),
  Layer_ShiP_SJLXJ: L.markerClusterGroup(),
  Layer_SJ_SJLXJ: L.markerClusterGroup(),
  Layer_TZ_SJLXJ: L.markerClusterGroup(),
  Layer_JG_SJLXJ: L.markerClusterGroup(),
  Layer_NPCShop_SJLXJ: L.markerClusterGroup(),
  Layer_NPC_SJLXJ: L.markerClusterGroup(),
  Layer_DYD_SJLXJ: L.markerClusterGroup(),
  Layer_MLDCD1_SJLXJ: L.markerClusterGroup(),
  Layer_SBLM_SJLXJ: L.markerClusterGroup(),
  Layer_DBY_SJLXJ: L.markerClusterGroup(),
  Layer_SYWD_SJLXJ: L.markerClusterGroup(),
  Layer_MLDCD_SJLXJ: L.markerClusterGroup(),
  Layer_WQDCD_SJLXJ: L.markerClusterGroup(),
  Layer_XWZM_SJLXJ: L.markerClusterGroup(),
  Layer_SX_SJLXJ: L.markerClusterGroup(),
  Layer_CSD_SJLXJ: L.markerClusterGroup(),
  Layer_LCMD_SJLXJ: L.markerClusterGroup(),
  Layer_MJ_SJLXJ: L.markerClusterGroup(),
  Layer_FB_SJLXJ: L.markerClusterGroup(),
  Layer_SYSK_SJLXJ: L.markerClusterGroup(),
  Layer_MSZXBJD_SJLXJ: L.markerClusterGroup(),
  Layer_RYLH_SJLXJ: L.markerClusterGroup(),
  Layer_MingCao_SJLXJ: L.markerClusterGroup(),
  Layer_HLZ_SJLXJ: L.markerClusterGroup(),
  Layer_PSDSB_SJLXJ: L.markerClusterGroup(),
  Layer_SJK_SJLXJ: L.markerClusterGroup(),
  Layer_BTK_SJLXJ: L.markerClusterGroup(),
  Layer_TK_SJLXJ: L.markerClusterGroup(),
  Layer_MJK_SJLXJ: L.markerClusterGroup(),
  Layer_ZJK_SJLXJ: L.markerClusterGroup(),
  Layer_KDCD_SJLXJ: L.markerClusterGroup(),
  Layer_YFZ_SJLXJ: L.markerClusterGroup(),
  Layer_HLG_SJLXJ: L.markerClusterGroup(),
  Layer_DGSN_SJLXJ: L.markerClusterGroup(),
  Layer_YJSW_SJLXJ: L.markerClusterGroup(),
  Layer_YJJB_SJLXJ: L.markerClusterGroup(),
  Layer_DXQQR_SJLXJ: L.markerClusterGroup(),
  Layer_SYFS_SJLXJ: L.markerClusterGroup(),
  Layer_LYSS_SJLXJ: L.markerClusterGroup(),
  Layer_DBT_SJLXJ: L.markerClusterGroup(),
  Layer_PPH_SJLXJ: L.markerClusterGroup(),
  Layer_XQD_SJLXJ: L.markerClusterGroup(),
  Layer_SLM_SJLXJ: L.markerClusterGroup(),
  Layer_KFZH_SJLXJ: L.markerClusterGroup(),
  Layer_QQR_SJLXJ: L.markerClusterGroup(),
  Layer_QQRSS_SJLXJ: L.markerClusterGroup(),
  Layer_QQSM_SJLXJ: L.markerClusterGroup(),
  Layer_ZWCLR_SJLXJ: L.markerClusterGroup(),
  Layer_PFL_SJLXJ: L.markerClusterGroup(),
  Layer_SJQ_SJLXJ: L.markerClusterGroup(),
  Layer_SHLX_SJLXJ: L.markerClusterGroup(),
  Layer_HaiDai_SJLXJ: L.markerClusterGroup(),
  Layer_JinGua_SJLXJ: L.markerClusterGroup(),
  Layer_MR_SJLXJ: L.markerClusterGroup(),
  Layer_SongR_SJLXJ: L.markerClusterGroup(),
  Layer_PX_SJLXJ: L.markerClusterGroup(),
  Layer_ShouR_SJLXJ: L.markerClusterGroup(),
  Layer_QR_SJLXJ: L.markerClusterGroup(),
  Layer_YR_SJLXJ: L.markerClusterGroup(),
  Layer_QD_SJLXJ: L.markerClusterGroup(),
  Layer_RLG_SJLXJ: L.markerClusterGroup(),
  Layer_PG_SJLXJ: L.markerClusterGroup(),
  Layer_JYC_SJLXJ: L.markerClusterGroup(),
  Layer_BLB_SJLXJ: L.markerClusterGroup(),
  Layer_HLB_SJLXJ: L.markerClusterGroup(),
  Layer_SG_SJLXJ: L.markerClusterGroup(),
  Layer_TTH_SJLXJ: L.markerClusterGroup(),
  Layer_MG_SJLXJ: L.markerClusterGroup(),
  Layer_BH_SJLXJ: L.markerClusterGroup(),
  Layer_SM_SJLXJ: L.markerClusterGroup(),
  Layer_SCDCD_SJLXJ: L.markerClusterGroup(),
  Layer_JH_SJLXJ: L.markerClusterGroup(),
  Layer_BWHHD_SJLXJ: L.markerClusterGroup(),
  Layer_LYHHR_SJLXJ: L.markerClusterGroup(),
  Layer_DQSJ_SJLXJ: L.markerClusterGroup(),
  Layer_FGS_SJLXJ: L.markerClusterGroup(),
  Layer_HDCB_SJLXJ: L.markerClusterGroup(),
  Layer_QW_SJLXJ: L.markerClusterGroup(),
  Layer_XYWB_SJLXJ: L.markerClusterGroup(),
  Layer_QQBY_SJLXJ: L.markerClusterGroup(),
  Layer_LiuShan_SJLXJ: L.markerClusterGroup(),
  Layer_YingShu_SJLXJ: L.markerClusterGroup(),
  Layer_YuJiaShu_SJLXJ: L.markerClusterGroup(),
  Layer_YuShanFeng_SJLXJ: L.markerClusterGroup(),
  ...
  Layer_SP_DXKQ: L.markerClusterGroup(),
...
var typearray = [
  ...
  [LayerMap['Layer_JW_SJLXJ'], JS_JW_SJLXJ, 'TC', 'JW_SJLXJ'],
  [LayerMap['Layer_BX_SJLXJ'], JS_BX_SJLXJ, 'TC', 'BX_SJLXJ'],
  [LayerMap['Layer_QKBX_SJLXJ'], JS_QKBX_SJLXJ, 'TC', 'QKBX_SJLXJ'],
  [LayerMap['Layer_DLK_SJLXJ'], JS_DLK_SJLXJ, 'TC', 'DLK_SJLXJ'],
  [LayerMap['Layer_SJRW_SJLXJ'], JS_SJRW_SJLXJ, 'TC', 'SJRW_SJLXJ'],
  [LayerMap['Layer_TFWT_SJLXJ'], JS_TFWT_SJLXJ, 'TC', 'TFWT_SJLXJ'],
  [LayerMap['Layer_ASKK_SJLXJ'], JS_ASKK_SJLXJ, 'TC', 'ASKK_SJLXJ'],
  [LayerMap['Layer_ND_SJLXJ'], JS_ND_SJLXJ, 'TC', 'ND_SJLXJ'],
  [LayerMap['Layer_JWJZ_SJLXJ'], JS_JWJZ_SJLXJ, 'TC', 'JWJZ_SJLXJ'],
  [LayerMap['Layer_CSZX_SJLXJ'], JS_CSZX_SJLXJ, 'TC', 'CSZX_SJLXJ'],
  [LayerMap['Layer_TYCS_SJLXJ'], JS_TYCS_SJLXJ, 'TC', 'TYCS_SJLXJ'],
  [LayerMap['Layer_ShiP_SJLXJ'], JS_ShiP_SJLXJ, 'TC', 'ShiP_SJLXJ'],
  [LayerMap['Layer_SJ_SJLXJ'], JS_SJ_SJLXJ, 'TC', 'SJ_SJLXJ'],
  [LayerMap['Layer_TZ_SJLXJ'], JS_TZ_SJLXJ, 'TC', 'TZ_SJLXJ'],
  [LayerMap['Layer_JG_SJLXJ'], JS_JG_SJLXJ, 'TC', 'JG_SJLXJ'],
  [LayerMap['Layer_NPCShop_SJLXJ'], JS_NPCShop_SJLXJ, 'TC', 'NPCShop_SJLXJ'],
  [LayerMap['Layer_NPC_SJLXJ'], JS_NPC_SJLXJ, 'TC', 'NPC_SJLXJ'],
  [LayerMap['Layer_DYD_SJLXJ'], JS_DYD_SJLXJ, 'TC', 'DYD_SJLXJ'],
  [LayerMap['Layer_MLDCD1_SJLXJ'], JS_MLDCD1_SJLXJ, 'TC', 'MLDCD1_SJLXJ'],
  [LayerMap['Layer_SBLM_SJLXJ'], JS_SBLM_SJLXJ, 'TC', 'SBLM_SJLXJ'],
  [LayerMap['Layer_DBY_SJLXJ'], JS_DBY_SJLXJ, 'TC', 'DBY_SJLXJ'],
  [LayerMap['Layer_SYWD_SJLXJ'], JS_SYWD_SJLXJ, 'TC', 'SYWD_SJLXJ'],
  [LayerMap['Layer_MLDCD_SJLXJ'], JS_MLDCD_SJLXJ, 'TC', 'MLDCD_SJLXJ'],
  [LayerMap['Layer_WQDCD_SJLXJ'], JS_WQDCD_SJLXJ, 'TC', 'WQDCD_SJLXJ'],
  [LayerMap['Layer_XWZM_SJLXJ'], JS_XWZM_SJLXJ, 'TC', 'XWZM_SJLXJ'],
  [LayerMap['Layer_SX_SJLXJ'], JS_SX_SJLXJ, 'TC', 'SX_SJLXJ'],
  [LayerMap['Layer_CSD_SJLXJ'], JS_CSD_SJLXJ, 'CSD', 'CSD_SJLXJ'],
  [LayerMap['Layer_LCMD_SJLXJ'], JS_LCMD_SJLXJ, 'TC', 'LCMD_SJLXJ'],
  [LayerMap['Layer_MJ_SJLXJ'], JS_MJ_SJLXJ, 'TC', 'MJ_SJLXJ'],
  [LayerMap['Layer_FB_SJLXJ'], JS_FB_SJLXJ, 'TC', 'FB_SJLXJ'],
  [LayerMap['Layer_SYSK_SJLXJ'], JS_SYSK_SJLXJ, 'TC', 'SYSK_SJLXJ'],
  [LayerMap['Layer_MSZXBJD_SJLXJ'], JS_MSZXBJD_SJLXJ, 'TC', 'MSZXBJD_SJLXJ'],
  [LayerMap['Layer_RYLH_SJLXJ'], JS_RYLH_SJLXJ, 'TC', 'RYLH_SJLXJ'],
  [LayerMap['Layer_MingCao_SJLXJ'], JS_MingCao_SJLXJ, 'TC', 'MingCao_SJLXJ'],
  [LayerMap['Layer_HLZ_SJLXJ'], JS_HLZ_SJLXJ, 'TC', 'HLZ_SJLXJ'],
  [LayerMap['Layer_PSDSB_SJLXJ'], JS_PSDSB_SJLXJ, 'TC', 'PSDSB_SJLXJ'],
  [LayerMap['Layer_SJK_SJLXJ'], JS_SJK_SJLXJ, 'TC', 'SJK_SJLXJ'],
  [LayerMap['Layer_BTK_SJLXJ'], JS_BTK_SJLXJ, 'TC', 'BTK_SJLXJ'],
  [LayerMap['Layer_TK_SJLXJ'], JS_TK_SJLXJ, 'TC', 'TK_SJLXJ'],
  [LayerMap['Layer_MJK_SJLXJ'], JS_MJK_SJLXJ, 'TC', 'MJK_SJLXJ'],
  [LayerMap['Layer_ZJK_SJLXJ'], JS_ZJK_SJLXJ, 'TC', 'ZJK_SJLXJ'],
  [LayerMap['Layer_KDCD_SJLXJ'], JS_KDCD_SJLXJ, 'TC', 'KDCD_SJLXJ'],
  [LayerMap['Layer_YFZ_SJLXJ'], JS_YFZ_SJLXJ, 'TC', 'YFZ_SJLXJ'],
  [LayerMap['Layer_HLG_SJLXJ'], JS_HLG_SJLXJ, 'TC', 'HLG_SJLXJ'],
  [LayerMap['Layer_DGSN_SJLXJ'], JS_DGSN_SJLXJ, 'TC', 'DGSN_SJLXJ'],
  [LayerMap['Layer_YJSW_SJLXJ'], JS_YJSW_SJLXJ, 'TC', 'YJSW_SJLXJ'],
  [LayerMap['Layer_YJJB_SJLXJ'], JS_YJJB_SJLXJ, 'TC', 'YJJB_SJLXJ'],
  [LayerMap['Layer_DXQQR_SJLXJ'], JS_DXQQR_SJLXJ, 'TC', 'DXQQR_SJLXJ'],
  [LayerMap['Layer_SYFS_SJLXJ'], JS_SYFS_SJLXJ, 'TC', 'SYFS_SJLXJ'],
  [LayerMap['Layer_LYSS_SJLXJ'], JS_LYSS_SJLXJ, 'TC', 'LYSS_SJLXJ'],
  [LayerMap['Layer_DBT_SJLXJ'], JS_DBT_SJLXJ, 'TC', 'DBT_SJLXJ'],
  [LayerMap['Layer_PPH_SJLXJ'], JS_PPH_SJLXJ, 'TC', 'PPH_SJLXJ'],
  [LayerMap['Layer_XQD_SJLXJ'], JS_XQD_SJLXJ, 'TC', 'XQD_SJLXJ'],
  [LayerMap['Layer_SLM_SJLXJ'], JS_SLM_SJLXJ, 'TC', 'SLM_SJLXJ'],
  [LayerMap['Layer_KFZH_SJLXJ'], JS_KFZH_SJLXJ, 'TC', 'KFZH_SJLXJ'],
  [LayerMap['Layer_QQR_SJLXJ'], JS_QQR_SJLXJ, 'TC', 'QQR_SJLXJ'],
  [LayerMap['Layer_QQRSS_SJLXJ'], JS_QQRSS_SJLXJ, 'TC', 'QQRSS_SJLXJ'],
  [LayerMap['Layer_QQSM_SJLXJ'], JS_QQSM_SJLXJ, 'TC', 'QQSM_SJLXJ'],
  [LayerMap['Layer_ZWCLR_SJLXJ'], JS_ZWCLR_SJLXJ, 'TC', 'ZWCLR_SJLXJ'],
  [LayerMap['Layer_PFL_SJLXJ'], JS_PFL_SJLXJ, 'TC', 'PFL_SJLXJ'],
  [LayerMap['Layer_SJQ_SJLXJ'], JS_SJQ_SJLXJ, 'TC', 'SJQ_SJLXJ'],
  [LayerMap['Layer_SHLX_SJLXJ'], JS_SHLX_SJLXJ, 'TC', 'SHLX_SJLXJ'],
  [LayerMap['Layer_HaiDai_SJLXJ'], JS_HaiDai_SJLXJ, 'TC', 'HaiDai_SJLXJ'],
  [LayerMap['Layer_JinGua_SJLXJ'], JS_JinGua_SJLXJ, 'TC', 'JinGua_SJLXJ'],
  [LayerMap['Layer_MR_SJLXJ'], JS_MR_SJLXJ, 'TC', 'MR_SJLXJ'],
  [LayerMap['Layer_SongR_SJLXJ'], JS_SongR_SJLXJ, 'TC', 'SongR_SJLXJ'],
  [LayerMap['Layer_PX_SJLXJ'], JS_PX_SJLXJ, 'TC', 'PX_SJLXJ'],
  [LayerMap['Layer_ShouR_SJLXJ'], JS_ShouR_SJLXJ, 'TC', 'ShouR_SJLXJ'],
  [LayerMap['Layer_QR_SJLXJ'], JS_QR_SJLXJ, 'TC', 'QR_SJLXJ'],
  [LayerMap['Layer_YR_SJLXJ'], JS_YR_SJLXJ, 'TC', 'YR_SJLXJ'],
  [LayerMap['Layer_QD_SJLXJ'], JS_QD_SJLXJ, 'TC', 'QD_SJLXJ'],
  [LayerMap['Layer_RLG_SJLXJ'], JS_RLG_SJLXJ, 'TC', 'RLG_SJLXJ'],
  [LayerMap['Layer_PG_SJLXJ'], JS_PG_SJLXJ, 'TC', 'PG_SJLXJ'],
  [LayerMap['Layer_JYC_SJLXJ'], JS_JYC_SJLXJ, 'TC', 'JYC_SJLXJ'],
  [LayerMap['Layer_BLB_SJLXJ'], JS_BLB_SJLXJ, 'TC', 'BLB_SJLXJ'],
  [LayerMap['Layer_HLB_SJLXJ'], JS_HLB_SJLXJ, 'TC', 'HLB_SJLXJ'],
  [LayerMap['Layer_SG_SJLXJ'], JS_SG_SJLXJ, 'TC', 'SG_SJLXJ'],
  [LayerMap['Layer_TTH_SJLXJ'], JS_TTH_SJLXJ, 'TC', 'TTH_SJLXJ'],
  [LayerMap['Layer_MG_SJLXJ'], JS_MG_SJLXJ, 'TC', 'MG_SJLXJ'],
  [LayerMap['Layer_BH_SJLXJ'], JS_BH_SJLXJ, 'TC', 'BH_SJLXJ'],
  [LayerMap['Layer_SM_SJLXJ'], JS_SM_SJLXJ, 'TC', 'SM_SJLXJ'],
  [LayerMap['Layer_SCDCD_SJLXJ'], JS_SCDCD_SJLXJ, 'TC', 'SCDCD_SJLXJ'],
  [LayerMap['Layer_JH_SJLXJ'], JS_JH_SJLXJ, 'TC', 'JH_SJLXJ'],
  [LayerMap['Layer_BWHHD_SJLXJ'], JS_BWHHD_SJLXJ, 'TC', 'BWHHD_SJLXJ'],
  [LayerMap['Layer_LYHHR_SJLXJ'], JS_LYHHR_SJLXJ, 'TC', 'LYHHR_SJLXJ'],
  [LayerMap['Layer_DQSJ_SJLXJ'], JS_DQSJ_SJLXJ, 'TC', 'DQSJ_SJLXJ'],
  [LayerMap['Layer_FGS_SJLXJ'], JS_FGS_SJLXJ, 'TC', 'FGS_SJLXJ'],
  [LayerMap['Layer_HDCB_SJLXJ'], JS_HDCB_SJLXJ, 'TC', 'HDCB_SJLXJ'],
  [LayerMap['Layer_QW_SJLXJ'], JS_QW_SJLXJ, 'TC', 'QW_SJLXJ'],
  [LayerMap['Layer_XYWB_SJLXJ'], JS_XYWB_SJLXJ, 'TC', 'XYWB_SJLXJ'],
  [LayerMap['Layer_QQBY_SJLXJ'], JS_QQBY_SJLXJ, 'TC', 'QQBY_SJLXJ'],
  [LayerMap['Layer_LiuShan_SJLXJ'], JS_LiuShan_SJLXJ, 'TC', 'LiuShan_SJLXJ'],
  [LayerMap['Layer_YingShu_SJLXJ'], JS_YingShu_SJLXJ, 'TC', 'YingShu_SJLXJ'],
  [LayerMap['Layer_YuJiaShu_SJLXJ'], JS_YuJiaShu_SJLXJ, 'TC', 'YuJiaShu_SJLXJ'],
  [LayerMap['Layer_YuShanFeng_SJLXJ'], JS_YuShanFeng_SJLXJ, 'TC', 'YuShanFeng_SJLXJ'],
  ...
  [LayerMap['Layer_SP_DXKQ'], JS_SP_DXKQ, 'TC', 'SP_DXKQ'],
...
map.on('popupopen', function (e) {
  ...
  $('.videoBtn').on('mouseenter mouseleave', function (event) {
    $('.videoTip').toggleClass('active')
  })
  if (isWebP) {
    $.ajax({
